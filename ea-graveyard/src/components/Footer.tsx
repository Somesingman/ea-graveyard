...
export function Footer() {
  ...
  return (
    <footer className="bg-red-400 dark:bg-red-900 max-h-[800px] lg:max-h-[600px] w-full text-white px-10 lg:px-0">
      <div className="flex flex-col max-w-[650px] self-center text-center mx-auto py-10 gap-y-5">
        ...
        <div className="flex flex-col text-lg gap-y-10">
          ...
          <p><a href="https://www.flaticon.com/authors/freepik" title="icon attribution" className="underline decoration-dashed" target="_blank" rel="noopener noreferrer">Icons created by Freepik - Flaticon</a></p>
        </div>
        <div>
        ...
        <div className="flex flex-row text-center self-center gap-4">
          <a href="https://bsky.app/profile/somesingman.bsky.social" target="_blank" rel="noopener noreferrer">
            <img src="./socials/bluesky_logo.svg" alt="BlueSky" className="h-[36px] w-[36px] fill-white" />
          </a>
          <a href="https://github.com/Somesingman" target="_blank" rel="noopener noreferrer">
